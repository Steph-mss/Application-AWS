...
router.post("/create", async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query("INSERT INTO vms (user_id, os, software, public_ip, private_key, vm_dir, name, instance_id, expires_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id", 
      [user_id, os, software, public_ip, privateKeyPath, userDir, vm_name, instance_id, expiresAt]);
