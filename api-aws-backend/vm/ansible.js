...
const runAnsiblePlaybook = async (inventoryPath, playbook, software, extensions, user_name, user_email, instance_id, user_password, vpn_ip, vm_dir, privateKeyPath, public_ip, emitProgress) => {
  try {
